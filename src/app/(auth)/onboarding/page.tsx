    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12" style={{ background: 'var(--bg)' }}>
      <div className="w-full max-w-lg">
        ...
        <div className="flex items-center gap-2 mb-8">
          ...
          <span className="font-semibold" style={{ color: 'var(--text)' }}>Grow OS</span>
        </div>
          ...
          <div className="flex items-center justify-between mb-3">
            {STEPS.map((s, i) => (
              <div key={s.id} className="flex items-center">
                ...
                {i < STEPS.length - 1 && (
                  <div className="h-px w-20 sm:w-32 mx-1 transition-all" style={{ background: step > s.id ? 'var(--accent)' : 'var(--border)' }} />
                )}
              </div>
            ))}
          </div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>
                  Grow OS uses this to auto-scale recipes to your exact setup.
                </p>
              </div>
